//Write a C program to perform the DFS traversal for a given graph (the program should be able to
//consider directed and undirected graph) using thebelow representations:
//a.adjacency list
//b.adjacency matrix
